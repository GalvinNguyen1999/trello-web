...
const Column = ({ column }) => {
  ...
  const deleteColumnConfirm = useConfirm()
  ...
  const onUpdateColumnTitle = (newTitle) => {
    updateColumnDetailsAPI(column._id, { title: newTitle }).then(() => {
      const newBoard = cloneDeep(board)
      const updateColumn = newBoard.columns.find(col => col._id === column._id)
      if (updateColumn) {
              ...
              <TextField
                ...
                sx={{
                  ...
                  '& .MuiOutlinedInput-root': {
                    ...
                    '&:hover fieldset': { borderColor: (theme) => theme.palette.text.primary },
                    '&.Mui-focused fieldset': { borderColor: (theme) => theme.palette.text.primary }
                  },
